...
class PreferenceSetListTableViewController: UITableViewController {
    ...
    private func loadSamplePreferenceSets() {
        ...
        guard let preference1 = PreferenceSet(name: "Gabby's Preferences", user: "Gabby Good", equipment: ["dumbbells", "squat rack", "treadmill"], bodyPart: ["arms", "quads"], numExercises: 10) else {
